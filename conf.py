...
BLOG_AUTHOR = "Rede de Modelagem em Dengue"
BLOG_TITLE = "PronexDengue"
...
BLOG_DESCRIPTION = "Essa é a rede Pronex de Modelagem em Dengue"
...
# Default is ''
CONTENT_FOOTER = 'Apoio CNPq, FAPERJ. Contents &copy; {date} <a href="mailto:{email}">{author}</a> - Powered by <a href="http://nikola.ralsina.com.ar">Nikola</a>'
