...
# in a prominent link
SITE_URL = "http://www.dengue.mat.br/"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/stories/equipe.html', 'Pessoas'),
        ('/stories/projetos.html', 'Projetos'),
        ('/stories/eventos.html', 'Eventos'),
        ('/stories/recursos.html', 'Recursos'),
